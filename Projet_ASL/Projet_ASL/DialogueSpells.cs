...
{
    public class DialogueSpells : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public DialogueSpells(Game jeu, Vector2 dimensionDialogue, ManagerNetwork managerNetwork)
           : base(jeu)
        {
